...
const Counting = () => {
  ...
  const [textOne, setTextOne] = useState('O,n,e,One');
  const [textTwo, setTextTwo] = useState('T,w,o,Two');
  const [textThree, setTextThree] = useState('T,h,r,e,e,Three');
  const [textFour, setTextFour] = useState('F,o,u,r,Four');
  const [textFive, setTextFive] = useState('F,i,v,e,Five');
  const [textSix, setTextSix] = useState('S,i,x,Six');
  const [textSeven, setTextSeven] = useState('S,e,v,e,n, Seven');
  const [textEight, setTextEight] = useState('E,i,g,h,t, Eight');
  const [textNine, setTextNine] = useState('N,i,n,e,Nine');
  const [textTen, setTextTen] = useState('T,e,n,Ten');
  const [textEleven, setTextEleven] = useState('E,l,e,v,e,n,Eleven');
  const [textTwelve, setTextTwelve] = useState('T,w,e,l,v,e,Twelve');
  const [textThirteen, setTextThirteen] = useState('T,h,i,r,t,e,e,n,Thirteen');
  const [textFourteen, setTextFourteen] = useState('F,o,u,r,t,e,e,n,Fourteen');
  const [textFifteen, setTextFifteen] = useState('F,i,f,t,e,e,n,Fifteen');
  const [textSixteen, setTextSixteen] = useState('S,i,x,t,e,e,n,Sixteen');
  const [textSeventeen, setTextSeventeen] = useState('S,e,v,e,n,t,e,e,n,Seventeen');
  const [textEighteen, setTextEighteen] = useState('E,i,g,h,t,e,e,n,Eighteen');
  const [textNineteen, setTextNineteen] = useState('N,i,n,e,t,e,e,n,Nineteen');
  const [textTwenty, setTextTwenty] = useState('T,w,e,n,t,y,Twenty');

  const [textTwentyOne, setTextTwentyOne] = useState('T,w,e,n,t,y, O,n,e, Twenty One');
  const [textTwentyTwo, setTextTwentyTwo] = useState('T,w,e,n,t,y, T,w,o, Twenty Two');
  const [textTwentyThree, setTextTwentyThree] = useState('T,w,e,n,t,y, T,h,r,e,e, Twenty Three');
  const [textTwentyFour, setTextTwentyFour] = useState('T,w,e,n,t,y, F,o,u,r, Twenty Four');
  const [textTwentyFive, setTextTwentyFive] = useState('T,w,e,n,t,y, F,i,v,e, Twenty Five');
  const [textTwentySix, setTextTwentySix] = useState('T,w,e,n,t,y, S,i,x, Twenty Six');
  const [textTwentySeven, setTextTwentySeven] = useState('T,w,e,n,t,y, S,e,v,e,n, Twenty Seven');
  const [textTwentyEight, setTextTwentyEight] = useState('T,w,e,n,t,y, E,i,g,h,t, Twenty Eight');
  const [textTwentyNine, setTextTwentyNine] = useState('T,w,e,n,t,y, N,i,n,e, Twenty Nine');
  const [textThirty, setTextThirty] = useState('T,h,i,r,t,y, Thirty');
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ImageBackground
        ...
        source={require('../../assets/newModuleAssests/images/counting3.jpg')}>
        ...
        /> */}
          <Swiper
            ...
            nextButtonStyle={{fontSize: 24, color: 'white', fontWeight: 'bold'}}
            prevButtonStyle={{fontSize: 24, color: 'white', fontWeight: 'bold'}}
            showsButtons={true}
            loop={false}>
            <View
              style={{
