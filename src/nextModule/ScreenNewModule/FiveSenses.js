...
//   const [textSmell, setTextSmell] = useState('Smell');
//   const [textTouch, setTextTouch] = useState('Touch');
//   const [textHearing, setTextHearing] = useState('Hearing');
//   const [textVision, setTextVision] = useState('Vision');
//   const [textTasting, setTextTasting] = useState('Tasting');
...
//   const readTextSmell = async () => {
//     Tts.stop();
//     Tts.speak(textSmell);
//   };

//   const readTextTouch = async () => {
//     Tts.stop();
//     Tts.speak(textTouch);
//   };

//   const readTextTasting = async () => {
//     Tts.stop();
//     Tts.speak(textTasting);
//   };

//   const readTextHearing = async () => {
//     Tts.stop();
//     Tts.speak(textHearing);
//   };

//   const readTextVision = async () => {
//     Tts.stop();
//     Tts.speak(textVision);
//   };
...
//               onPress={readTextSmell}>
//               <Image
//                 style={styles.image}
//                 source={require('../../assets/newModuleAssests/images/smell.png')}
//               />
//             </TouchableOpacity>

//             <TouchableOpacity
//               style={styles.buttonStyle}
//               onPress={readTextTouch}>
//               <Image
//                 style={styles.image}
//                 source={require('../../assets/newModuleAssests/images/touch.png')}
//               />
//             </TouchableOpacity>
//           </View>
...
//             <TouchableOpacity
//               style={styles.buttonStyle}
//               onPress={readTextTasting}>
//               <Image
//                 style={styles.image}
//                 source={require('../../assets/newModuleAssests/images/tasting.png')}
//               />
//             </TouchableOpacity>
//             <TouchableOpacity
//               style={styles.buttonStyle}
//               onPress={readTextHearing}>
//               <Image
//                 style={styles.image}
//                 source={require('../../assets/newModuleAssests/images/listening.png')}
//               />
//             </TouchableOpacity>
//           </View>
...
//             <TouchableOpacity
//               style={styles.buttonStyle}
//               onPress={readTextVision}>
//               <Image
//                 style={styles.image}
//                 source={require('../../assets/newModuleAssests/images/vision.png')}
//               />
//             </TouchableOpacity>
//           </View>
//         </View>
...
const AnimalList = [
  {
    name: 'Touch',
    image: require('../../assets/newModuleAssests/images/touch.png'),
  },
  {
    name: 'Vision',
    image: require('../../assets/newModuleAssests/images/vision.png'),
  },
  {
    name: 'Taste',
    image: require('../../assets/newModuleAssests/images/tasting.png'),
  },
  {
    name: 'Touch',
    image: require('../../assets/newModuleAssests/images/touch.png'),
...
export default FiveSensesScreen;
